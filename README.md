![docker image](https://github.com/CCP-NC/ccpnc-nomad-oasis/actions/workflows/docker-publish.yml/badge.svg)


# CCP-NC's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of CCP-NC.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/CCP-NC/ccpnc-nomad-oasis.git
    cd ccpnc-nomad-oasis
    ```

    or

    ```sh
    curl-L -o ccpnc-nomad-oasis.zip "https://github.com/CCP-NC/ccpnc-nomad-oasis/archive/main.zip"
    unzip ccpnc-nomad-oasis.zip
    cd ccpnc-nomad-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/ccp-nc/ccpnc-nomad-oasis:main` for the services
...
```
docker pull ghcr.io/ccp-nc/ccpnc-nomad-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/CCP-NC/ccpnc-nomad-oasis/manifests/main": unauthorized`
