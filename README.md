...
```sh
curl -L -o nomad-oasis.zip "https://github.com/CCP-NC/ccpnc-nomad-oasis/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/CCP-NC/ccpnc-nomad-oasis/manifests/main": unauthorized`
